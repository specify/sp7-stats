        ...
        foreach($institutions as $institution => $disciplines){
                ...
                foreach($disciplines as $discipline => $collections){
                        ...
                        foreach($collections as $collection => $data){
                                ...
                                if (isset($data['collectionObjectCount'])) {
                                        echo 'Collection Objects: ' . intval($data['collectionObjectCount']) . '<br>';
                                }
                                if (isset($data['collectionCount'])) {
                                        echo 'Collections: ' . intval($data['collectionCount']) . '<br>';
                                }
                                if (isset($data['userCount'])) {
                                        echo 'Users: ' . intval($data['userCount']) . '<br>';
                                }
                ...
                foreach($institutions as $institution => $disciplines){
                        ...
                        foreach($disciplines as $discipline => $collections){
                                ...
                                foreach($collections as $collection => $data){
                                        ...
                                        if (isset($data['collectionObjectCount'])) {
                                                to_cell(4, 'Collection Objects');
                                                to_cell(5, intval($data['collectionObjectCount']));
                                        }
                                        else {
                                                to_cell(4, 'Collection Objects');
                                                to_cell(5, 'N/A');
                                        ...
                                        if (isset($data['collectionCount'])) {
                                                to_cell(4, 'Collections');
                                                to_cell(5, intval($data['collectionCount']));
                                        }
                                        else {
                                                to_cell(4, 'Collections');
                                                to_cell(5, 'N/A');
                                        ...
                                        if (isset($data['userCount'])) {
                                                to_cell(4, 'Users');
                                                to_cell(5, intval($data['userCount']));
                                        }
                                        else {
                                                to_cell(4, 'Users');
                                                to_cell(5, 'N/A');
